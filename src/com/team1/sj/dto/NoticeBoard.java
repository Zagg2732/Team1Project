...
public class NoticeBoard {
 ...
 public NoticeBoard(int idx, int idx_fk, int up, int down, int readnum, Date writedate, 
...
public String toString() {
	return "NoticeBoard [idx=" + idx + ", idx_fk=" + idx_fk + ", up=" + up + ", down=" + down + ", readnum=" + readnum
