            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ㅁ 높은 조회수 게시물</h1>
                    </div>
									...
									<tbody>
										...
										<c:forEach var="user" items="${list}">
											<tr>
												...
												<td align="center">${user.userid_fk}</td>
												<td align="center"><a href="kimsboardcontent.kims?idx=${user.idx}">${user.subject}</a></td>
