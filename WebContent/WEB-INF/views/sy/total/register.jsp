		...
		<section id="registersection">
			...
			<form id="msform" action="${pageContext.request.contextPath}/RegisterOk.team1" method="post">
				...
				<fieldset>
					...
					<input type="checkbox" name="termsCheck" id="termsCheck" value="agree" style="width:30px;" />
				...
				<fieldset id="step22">
					...
					<h3 class="fs-subtitle">사용하실 정보를 입력해주세요</h3>
					
					<input type="text" name="userId" id="userId" placeholder="ID" style="width:52%;"/>
					<input type="button" name="idCheck" id="idCheck" class="action-button" value="중복확인" onclick="overlapCheckID()">
